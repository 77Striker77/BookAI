...
sprache_erlebt: "de"
rating_schnitt: "~4,4/5"             # Goodreads „The Good Guys"-Serie 4,38
rating_stimmen_gesamt: "⚠️ Gesamtzahl über beide Reihen nicht belegt"
...
performance: "solo (je Reihe eigener Sprecher)"
genres: [LitRPG, GameLit, Action-Komödie]
themen: []                           # reihen-spezifische Themen in den Reihen-Notizen
...
# Vuldranni (iNcarn8) — Overall-Ebene
...
- **Hörbuch DE:** zwei verschiedene Sprecher — [[Robert Frank]] (guten Jungs) /
  ...
  hinterher (belegt bis GJ Bd. 9 / BJ Bd. 8; aktueller Stand darüber hinaus offen).
- **Hörbuch EN:** Neil Hellegers (Tantor/Audible)

## Hierarchie (Overall → Reihen)

```
Vuldranni (iNcarn8) (Overall)
 ├─→ [[Die guten Jungs]]   16 Bde (2018–2025) · Montana Coggeshall · Robert Frank
 └─→ [[Die bösen Jungs]]   11 Bde (2019–2024) · Clyde Hatchett · Thomas Nicolai
     (EN zusätzlich: The Grim Guys — nicht auf Deutsch, nicht erlebt)
```
...
1. **[[Die guten Jungs]] ist die Basis.** Sie legt Welt, Adel/Politik und die großen
   Ereignisse von Vuldranni. Belegt: Leser-Empfehlung, erst die guten Jungs zu lesen, „um
   ein gutes Hintergrundwissen über die Welt Vuldranni und ihre politischen Entwicklungen
   zu bekommen" — dadurch versteht und genießt man die bösen Jungs deutlich mehr.
2. **Umstieg nach GJ 5.** [[Die bösen Jungs]] Bd. 1 („Schurken & Halunken", EN „Scamps &
...
| --- | --- | --- |
| [[Absurder Humor]] | +2 | „Humor/Ton zündet" · „Humor & Schnoddrigkeit" |
| [[Tonwechsel Humor-Ernst]] | +2 | „Humor/Ton zündet" (Schnoddrigkeit + echte Härte) |
| [[Pragmatischer Held mit klarem Kompass]] | +2 | „Held ist stark" — gilt für Montana UND Clyde |
| [[Stimmige Weltatmosphäre]] | +2 | „Welt, gehemienisse und monster" |
| [[Über-crunchiges Zahlensystem]] | **−1** | „ab und zu … zu viel vorgelese von status skills und co. **aber wirklich nur ein mini negativer punkt**" |

### Eingebracht von [[Die guten Jungs]]

| Aspekt | Wertung |
| --- | --- |
| [[Basisaufbau & Siedlungsentwicklung]] · [[Weltgeheimnisse & Entdeckung]] · [[Monster-Vielfalt & Bestiarium]] · [[Handfeste Kampf-Action]] | je +2 |
| 🎙️ [[Robert Frank]] | +2 |
| [[Intrigen-Overload ohne Progress]] | 0 (Schwelle — „noch in einem okey maße") |

### Eingebracht von [[Die bösen Jungs]]
...
Welt** — die drei Achsen, die auch [[Dungeon Crawler Carl]] tragen. Neu und wertvoll für
das Profil sind zwei Dinge: (1) **[[Basisaufbau & Siedlungsentwicklung]]** als eigener
Plus-Anker (Herzogtum aufbauen statt nur durchziehen) — das gab es im Vault so noch nicht;
...
- **Genre:** [[LitRPG]] / GameLit / Action-Komödie · Zugang über das Spiel **iNcarn8**
- **Setting:** Vuldranni — [[Stimmige Weltatmosphäre]], [[Monster-Vielfalt & Bestiarium]],
  Adels-/Fraktionspolitik (dosiert: [[Intrigen-Overload ohne Progress]] auf 0)
- **Ton:** [[Absurder Humor]] + [[Tonwechsel Humor-Ernst]] (Ugland-Handschrift)
- **Figuren:** zwei [[Pragmatischer Held mit klarem Kompass]] von zwei Seiten der Moral

## Hörbuch-Erlebnis (Verbund-Besonderheit)

**Erster Fall im Vault mit zwei Sprechern in EINEM Universum** — und der Nutzer stellt sie
direkt gegeneinander: [[Robert Frank]] **+2**, [[Thomas Nicolai]] **−1** („Stimmfarbe passt
nicht", „Tempo & Betonung"; ausdrücklich „nur im Vergleich schwächer"). Für Empfehlungen
heißt das: der Sprecher ist **kein** inhaltliches Matching-Kriterium (Konventionen), aber
hier belegt er, wie stark er das Erlebnis färbt — beim verschränkten Hören wechselt die
Stimme ständig.

## 🧮 Community-Gesamtbild des Verbunds

- [[Die guten Jungs]]: Goodreads-Serie **⌀ 4,38**.
- [[Die bösen Jungs]]: ⚠️ Serien-Durchschnitt nicht belegt (Goodreads/Audible via Proxy
  geblockt); einzelner Snippet-Wert Amazon.de „Darktown Funk" 4,6 · 733 Bew. — **unbestätigt**.
- **Roter Faden der Community:** beide Reihen unabhängig lesbar, aber „aufmerksame Leser
  beider Serien werden sich daran erfreuen können, dass manch weltbewegendes Ereignis aus
  zwei Perspektiven miterlebt werden kann" — genau das, was die Hörreihenfolge nutzbar macht.

## Offene Fragen

- ⚠️ **Aktueller dt. Hörbuch-Stand beider Reihen** (letzter erschienener Band je Reihe,
  Termine kommender Bände) — Audible.de/BücherTreff/Goodreads sind in dieser Session vom
